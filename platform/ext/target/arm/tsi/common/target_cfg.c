...
/* Import PPC drivers */
extern ARM_DRIVER_PPC_TSI Driver_MAIN0_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_MAIN_EXP0_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_MAIN_EXP1_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_MAIN_EXP2_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_MAIN_EXP3_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_PERIPH0_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_PERIPH1_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_PERIPH_EXP0_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_PERIPH_EXP1_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_PERIPH_EXP2_PPC_TSI;
extern ARM_DRIVER_PPC_TSI Driver_PERIPH_EXP3_PPC_TSI;
...
static ARM_DRIVER_PPC_TSI *const ppc_bank_drivers[] = {
        &Driver_MAIN0_PPC_TSI,
        &Driver_MAIN_EXP0_PPC_TSI,
        &Driver_MAIN_EXP1_PPC_TSI,
        &Driver_MAIN_EXP2_PPC_TSI,
        &Driver_MAIN_EXP3_PPC_TSI,
        &Driver_PERIPH0_PPC_TSI,
        &Driver_PERIPH1_PPC_TSI,
        &Driver_PERIPH_EXP0_PPC_TSI,
        &Driver_PERIPH_EXP1_PPC_TSI,
        &Driver_PERIPH_EXP2_PPC_TSI,
        &Driver_PERIPH_EXP3_PPC_TSI
};
...
{
    struct tsi_sysctrl_t *sysctrl =
                            (struct tsi_sysctrl_t *)TSI_SYSCTRL_BASE_S;
...
0xD0000000+--------+------+  +--------+      |       | +------------+
          | DDR4 7 |   S  |  | DDR4 7 |      |       | |     S      |
0xE0000000+--------+------+  +--------+------+-------+ +------------*/
    struct tsi_sacfg_t *sacfg = (struct tsi_sacfg_t*)TSI_SACFG_BASE_S;
...
{
    struct tsi_sacfg_t *sacfg =
                                (struct tsi_sacfg_t*)TSI_SACFG_BASE_S;
    int32_t err = ARM_DRIVER_OK;

    /* Grant non-secure access to peripherals on MAIN EXP0 */
    err |= Driver_MAIN_EXP0_PPC_TSI.Initialize();
    err |= Driver_MAIN_EXP0_PPC_TSI.ConfigSecurity(
                                        GPIO0_MAIN_PPCEXP0_POS_MASK,
                                        ARM_PPC_TSI_NONSECURE_CONFIG);
    err |= Driver_MAIN_EXP0_PPC_TSI.ConfigSecurity(
    ...
    err |= Driver_PERIPH0_PPC_TSI.Initialize();
    err |= Driver_PERIPH0_PPC_TSI.ConfigSecurity(
                                        SYSTEM_TIMER0_PERIPH_PPC0_POS_MASK,
                                        ARM_PPC_TSI_NONSECURE_CONFIG);
    err |= Driver_PERIPH0_PPC_TSI.ConfigSecurity(
    ...
    err |= Driver_PERIPH1_PPC_TSI.Initialize();
    err |= Driver_PERIPH1_PPC_TSI.ConfigSecurity(
                                        SLOWCLK_TIMER_PERIPH_PPC1_POS_MASK,
                                        ARM_PPC_TSI_NONSECURE_CONFIG);

    /* Grant non-secure access to peripherals on PERIPH EXP2 */
    err |= Driver_PERIPH_EXP2_PPC_TSI.Initialize();

    err |= Driver_PERIPH_EXP2_PPC_TSI.ConfigSecurity(
    ...
    err |= Driver_PERIPH_EXP2_PPC_TSI.ConfigPrivilege(
                                        UART0_PERIPH_PPCEXP2_POS_MASK,
                                        ARM_PPC_TSI_NONSECURE_CONFIG,
                                        ARM_PPC_TSI_PRIV_AND_NONPRIV_CONFIG);

    /* Initialize not used PPC drivers */
    err |= Driver_MAIN0_PPC_TSI.Initialize();
    err |= Driver_MAIN_EXP1_PPC_TSI.Initialize();
    err |= Driver_MAIN_EXP2_PPC_TSI.Initialize();
    err |= Driver_MAIN_EXP3_PPC_TSI.Initialize();
    err |= Driver_PERIPH_EXP0_PPC_TSI.Initialize();
    err |= Driver_PERIPH_EXP1_PPC_TSI.Initialize();
    err |= Driver_PERIPH_EXP3_PPC_TSI.Initialize();
...
void ppc_configure_to_secure(ppc_bank_t bank, uint32_t pos)
{
    ...
    if (ppc_driver) {
        ppc_driver->ConfigSecurity(pos, ARM_PPC_TSI_SECURE_CONFIG);
    }
}
...
void ppc_configure_to_non_secure(ppc_bank_t bank, uint32_t pos)
{
    ...
    ppc_driver = ppc_bank_drivers[bank];
    if (ppc_driver) {
        ppc_driver->ConfigSecurity(pos, ARM_PPC_TSI_NONSECURE_CONFIG);
    }
}
