...
typedef enum _ARM_PPC_TSI_SecAttr {
    ARM_PPC_TSI_SECURE_CONFIG = 0,    /*!< Secure access */
    ARM_PPC_TSI_NONSECURE_CONFIG,     /*!< Non-secure access */
} ARM_PPC_TSI_SecAttr;

/* Privilege attribute used to configure the peripheral */
typedef enum _ARM_PPC_TSI_PrivAttr {
    ARM_PPC_TSI_PRIV_AND_NONPRIV_CONFIG = 0, /*!< Privilege and non-privilege
                                             * access */
    ARM_PPC_TSI_PRIV_CONFIG,                 /*!< Privilege only access */
} ARM_PPC_TSI_PrivAttr;
...
/**
  ...
  \fn          ARM_DRIVER_VERSION PPC_TSI_GetVersion(void)
  \brief       Get driver version.
  \return      \ref ARM_DRIVER_VERSION

  \fn          int32_t PPC_TSI_Initialize(void)
  \brief       Initializes PPC Interface.
  \return      Returns TSI PPC error code.

  \fn          int32_t PPC_TSI_Uninitialize(void)
  \brief       De-initializes PPC Interface.
  \return      Returns TSI PPC error code.

  \fn          int32_t PPC_TSI_ConfigPrivilege(uint32_t periph,
                                                  ARM_PPC_TSI_SecAttr sec_attr,
                                                  ARM_PPC_TSI_PrivAttr priv_attr)
  ...
  \fn          bool PPC_TSI_IsPeriphPrivOnly (uint32_t periph)
  ...
  \fn          int32_t PPC_TSI_ConfigSecurity(uint32_t periph,
                                                 ARM_PPC_TSI_SecAttr sec_attr)
  ...
  \fn          bool PPC_TSI_IsPeriphSecure (uint32_t periph)
  ...
  \fn          int32_t PPC_TSI_EnableInterrupt (void)
  \brief       Enables PPC interrupt.
  \return      Returns TSI PPC error code.

  \fn          void PPC_TSI_DisableInterrupt (void)
  \brief       Disables PPC interrupt.

  \fn          void PPC_TSI_ClearInterrupt (void)
  \brief       Clears PPC interrupt.

  \fn          bool PPC_TSI_InterruptState (void)
 ...
 */
typedef struct _ARM_DRIVER_PPC_TSI {
  ...
  int32_t             (*ConfigPrivilege)  (uint32_t periph, ARM_PPC_TSI_SecAttr sec_attr, ARM_PPC_TSI_PrivAttr priv_attr);  ///< Pointer to \ref ARM_PPC_ConfigPeriph : Configure a peripheral controlled by the PPC.
  ...
  int32_t             (*ConfigSecurity)   (uint32_t periph, ARM_PPC_TSI_SecAttr sec_attr);  ///< Pointer to \ref ARM_PPC_ConfigPeriph : Configure a peripheral controlled by the PPC.
