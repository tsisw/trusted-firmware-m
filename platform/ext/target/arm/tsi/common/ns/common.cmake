...
target_sources(platform_ns
    PRIVATE
        ${TSI_COMMON_DIR}/device/source/platform_ns_device_definition.c
        ${TSI_COMMON_DIR}/cmsis_drivers/Driver_USART.c
        ${PLATFORM_DIR}/ext/target/arm/drivers/usart/cmsdk/uart_cmsdk_drv.c
    INTERFACE
        $<$<BOOL:${TEST_NS_FPU}>:${TSI_COMMON_DIR}/device/source/tsi_ns_init.c>
...
target_include_directories(platform_ns
    PUBLIC
        ...
        ${TSI_COMMON_DIR}/cmsis_drivers/config/non_secure
)
